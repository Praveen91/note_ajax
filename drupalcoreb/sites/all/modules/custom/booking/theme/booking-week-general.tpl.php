...
<div class="nw-week-wraper">
  ...
  <div class="nw-week-paging">
    <?php if($page < $total_page): ?>
      <div class="nw-week-previous action-links" ><a class="nw-week-previous-action" href="javascript:void(0)"><?php print t('<< Last week'); ?></a></div>
      <div class="nw-week-next action-links" data="1"><a class="nw-week-next-action" href="javascript:void(0)"><?php print t('Next week >>'); ?></a></div>
    <?php endif; ?>
  </div>
